...
class DirDiff(melddoc.MeldDoc, gnomeglade.Component):
    ...
    def on_file_filter_menu_toggled(self, item):
        if item.get_active():
            ...
            self.file_filter_popup.popup(None, None,
    ...
    def create_file_filters(self):
        ...
        old_active = set([f.filter_string for f in self.file_filters
                          if f.active])
    ...
    def create_text_filters(self):
        ...
        for i, f in enumerate(self.text_filters):
            name = "DirdiffHideTextFilter%d" % i
        ...
        self.text_filter_actiongroup = Gtk.ActionGroup(name="DirdiffTextFilterActions")
    ...
    def _show_identical_status(self):
        ...
        have_file_filters = any(f.active for f in self.file_filters)
